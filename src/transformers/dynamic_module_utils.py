...
def get_class_in_module(class_name, module_path):
    ...
    # OK [with shutil.copy or with shutil.copyfile above]: os.system(f"cp {module_dir_backup_temp}/{module_file_name} {module_dir}")
    # OK shutil.copyfile(os.path.join(module_dir_backup_temp, module_file_name), os.path.join(module_dir, module_file_name))
